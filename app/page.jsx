          ...
          <div className="flex flex-col gap-4 w-auto max-w-[400px] text-center xl:text-left">
            ...
            >
              <h1 className="h1">
                Hello,
                <br />
                I'm <span className="text-accent">Cesar!</span>
              </h1>
            </motion.div>
            {/* bio */}
            <motion.div
            ...
            >
              <p>
                ...
                cross-platform applications and leading high-impact projects
            ...
            <div className="flex flex-col xl:flex-row items-center justify-center xl:items-center xl:justify-start gap-6 pt-2">
              <motion.a
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.2 }}
                href="/assets/__CesarValencia_FullStack.pdf"
                download
                aria-label="Download Cesar's CV"
              >
                <Button
                  variant="outline"
                  size="md"
